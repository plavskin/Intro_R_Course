...
You should have a dataset in csv format called *iris.csv*. This is a set of information on flower structure collected from plants of 3 iris species. Follow along with this file as we go through the rules. The code below will only work if you have iris.csv saved in the same folder as this file. You can download it here:
