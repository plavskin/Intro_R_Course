...
One very useful construct in programming is a conditional statement. It allows you to run different things in different situations. This won't really be used in our simulation, but it's really useful in many other contexts. These statements look something like this:
```{}
